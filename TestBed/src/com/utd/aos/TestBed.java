...
import com.aos.threads.GetDataThread;
...
public class TestBed {
	...
	public final static int TOTAL_NUMBER_OF_NODES = 4;
...
//			      }
	...
	public static void stopExecution()
	{
		try {
			...
			for(int i=1;i<= TOTAL_NUMBER_OF_NODES;i++)
			{
				Session session = jsch.getSession(cred[0], SERVER_ADDRESS_PREFIX + String.format("%02d",i) + SERVER_ADDRESS_SUFFIX, 22);
